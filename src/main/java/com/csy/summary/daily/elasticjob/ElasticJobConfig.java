...
public class ElasticJobConfig {
    ...
    private LiteJobConfiguration createJobConfiguration(final Class<? extends SimpleJob> jobClass,
        ...
        return LiteJobConfiguration.newBuilder(simpleJobConfiguration).overwrite(true)
                //设置dump端口
                .monitorPort(9888)
                .build();
    }
    ...
    private LiteJobConfiguration createFlowJobConfiguration(final Class<? extends ElasticJob> jobClass,
        ...
        //创建LiteJobConfiguration
        return LiteJobConfiguration.newBuilder(jobConfig).overwrite(true)
                //设置dump端口
                // .monitorPort(9888)
                .build();
    }
    ...
    public SpringJobScheduler initSimpleElasticJob() {
        ...
        return new SpringJobScheduler(fileBackupJob, registryCenter,
                createJobConfiguration(fileBackupJob.getClass(), "0 0/3 * * * ?", 1, "0=text,1=image,2=radio,3=vedio")
                , jobEventConfig);
    }
}